          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-blue-100 text-lg leading-relaxed">
                {scholarship.type} scholarship for {scholarship.levels.join(', ')} program{scholarship.percentage ? ` with ${scholarship.percentage}% discount on tuition fees` : ''}.
              </p>
            </div>
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Renewal Conditions */}
              {scholarship.renewalConditions && scholarship.renewalConditions.length > 0 && (
                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
