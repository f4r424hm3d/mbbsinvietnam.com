...
interface DownloadBrochurePopupProps {
  isOpen: boolean;
  onClose: () => void;
}

const DownloadBrochurePopup: React.FC<DownloadBrochurePopupProps> = ({ isOpen, onClose }) => {
        ...
        {submitSuccess ? (
          <div className="text-center">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <p className="text-green-800 text-lg font-medium">
                ✓ Your brochure request has been submitted successfully.
              </p>
              <p className="text-green-800 text-lg font-medium mt-2">
                We will send you the brochure via email shortly.
              </p>
            </div>
          </div>
        ) : (
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">Fill in the details to download our comprehensive MBBS brochure.</p>
            </div>
            ...
            >
              ...
              {isDownloading ? 'Processing...' : 'Download Brochure'}
            </button>
          </>
        )}
      </div>
