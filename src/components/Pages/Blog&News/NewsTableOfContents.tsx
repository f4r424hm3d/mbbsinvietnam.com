...
interface NewsTableOfContentsProps {
  parentContents: NewsParentContent[];
}

const NewsTableOfContents: React.FC<NewsTableOfContentsProps> = ({ parentContents }) => {
